...
const userDetailsFormSchema = z.object({
  ...
  file_extension: z.string().optional(),
    ...
    // Assuming userDetails is an object with the properties: phone, address, bio, and profile_pic_url
    // You can replace this with your actual user details type

interface ProfileDetailsCardProps {
    userDetails: UserDetails; // userDetails should be passed here
    clerkId: string;
  }
